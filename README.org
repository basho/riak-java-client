...
As a convenience we also provide an [[http://riak-java-client.s3.amazonaws.com/riak-client-1.4.2-jar-with-dependencies.jar][all-in-one .jar file you can include in non-maven projects]]
