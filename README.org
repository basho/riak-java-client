...
As a convenience we also provide an [[http://riak-java-client.s3.amazonaws.com/riak-client-1.1.3-jar-with-dependencies.jar][all-in-one .jar file you can include in non-maven projects]]
