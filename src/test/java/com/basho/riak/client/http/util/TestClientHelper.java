...
public class TestClientHelper {
    ...
    @Test public void store_will_return_key_generated_by_server_when_no_key_is_provided() throws ClientProtocolException, IOException {
		...
		assertEquals("Key generated by server should be assigned to object in response.", generatedKey, storeResponse.getKey());
    }
