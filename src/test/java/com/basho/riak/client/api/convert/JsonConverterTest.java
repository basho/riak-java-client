...
public class JsonConverterTest
{
    ...
    public void testRiakAnnotatedMethodsExcludedFromJson() throws IOException
    {
        ...
        JSONConverter<PojoWithRiakMethods> jc = new JSONConverter<>(new TypeReference<PojoWithRiakMethods>() {});
    ...
    public void testRiakAnnotatedMethodsIncludedInJson() throws IOException
    {
        ...
        JSONConverter<PojoWithRiakMethodsIncluded> jc =
                new JSONConverter<>(new TypeReference<PojoWithRiakMethodsIncluded>() {});
    ...
    public void convertBackAndForth()
    {
        ...
        JSONConverter<EmptyPojoWithRiakFields> jc = new JSONConverter<>(new TypeReference<EmptyPojoWithRiakFields>() {});
    ...
    {
        JSONConverter<String> jcs = new JSONConverter<>(new TypeReference<String>() {});
        ...
        JSONConverter<Integer> jci = new JSONConverter<>(new TypeReference<Integer>() {});
