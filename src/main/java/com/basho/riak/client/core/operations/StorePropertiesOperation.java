...
public abstract class StorePropertiesOperation<S> extends FutureOperation<Void, Void, S>
{
    protected S bucketOrType = null;

    protected StorePropertiesOperation(S bucketOrType)
    {
