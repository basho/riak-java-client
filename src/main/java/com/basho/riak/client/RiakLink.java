...
/**
 * Models a link from one object to another in Riak. <p> Links are
 * unidirectional and enable lightweight graph semantics in Riak. See <a
 * href="http://wiki.basho.com/Links.html">the basho wiki</a> for more details
 * on links. </p>
 *
