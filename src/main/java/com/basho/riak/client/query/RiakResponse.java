...
public class RiakResponse<T>
{
    ...
    private RiakResponse(Builder<T> builder)
    {
    ...
    /**
     * Returns the key for the returned content.
     *
     * @return the key
     */
    ...
    /**
     * Returns the bucket the returned content resides in.
     *
    ...
    /**
     * Returns the bucket type the returned content resides in.
     *
     ...
     *
     * @return true if there is content in this response.
     */
    ...
    public static class Builder<T>
    {
        ...
        public RiakResponse<T> build()
        {
            return new RiakResponse<T>(this);
        }
    }
}
