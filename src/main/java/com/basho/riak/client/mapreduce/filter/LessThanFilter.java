 ...
 *             com.basho.riak.client.http.mapreduce.filter.LessThanFilter
 *             instead.
 *             <p>WARNING: This class will be REMOVED in the next version.</p>
 * @see com.basho.riak.client.http.mapreduce.filter.LessThanFilter
 */
@Deprecated
public class LessThanFilter implements MapReduceFilter {
    ...
    public LessThanFilter(double lessThan) throws JSONException {
        args.put("less_than");
        args.put(lessThan);
    }
