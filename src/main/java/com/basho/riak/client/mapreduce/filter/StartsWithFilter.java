 ...
 *             com.basho.riak.client.http.mapreduce.filter.StartsWithFilter
 *             instead.
 *             <p>WARNING: This class will be REMOVED in the next version.</p>
 * @see com.basho.riak.client.http.mapreduce.filter.StartsWithFilter
 */
@Deprecated
public class StartsWithFilter implements MapReduceFilter {
    ...
    public StartsWithFilter(String startsWithFilter) {
        args.put("starts_with");
        args.put(startsWithFilter);
    }
