 ...
 *             com.basho.riak.client.http.mapreduce.filter.LogicalAndFilter
 *             instead.
 *             <p>WARNING: This class will be REMOVED in the next version.</p>
 * @see com.basho.riak.client.http.mapreduce.filter.LogicalAndFilter
 */
@Deprecated
public class LogicalAndFilter implements MapReduceFilter {
    ...
    public LogicalAndFilter(MapReduceFilter... filters) {
        args.put("and");
    ...
    public LogicalAndFilter add(MapReduceFilter filter) {
        args.put(filter.toJson());
        return this;
    }
