...
// TODO: Error from Riak = retry?
// TODO: Drop FutureOperation as an interface?
abstract class BaseOperation<T> implements FutureOperation<T>, Future<T>
{
    private enum State { CREATED, WRITTEN, COMPLETE, CANCELLED }
    private final Logger logger = LoggerFactory.getLogger(BaseOperation.class);
    ...
    @Override
    public final synchronized void setRetrier(OperationRetrier retrier, int numRetries)
    {
    ...
    @Override
    public final List<Protocol> getProtocolPreflist()
    {
    ...
    @Override
    public final synchronized void setResponse(RiakResponse rawResponse)
    {
    ...
    @Override
    public final synchronized void setException(Throwable t)
    {
        this.exception = t;
        state = State.COMPLETE;
    ...
    @Override
    public final synchronized Object channelMessage(Protocol p)
    {
