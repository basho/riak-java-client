...
public class FetchMeta
{
    ...
    {
        return new FetchMeta(readQuorum, null, null, null, null, null, null);
    }
    ...
    public static class Builder
    {
        ...
        {
            return new FetchMeta(r, pr, notFoundOK, basicQuorum, headOnly, returnDeletedVClock, vclock);
        }
    ...
    public static FetchMeta head()
    {
        ...
        return new FetchMeta((Quorum) null, null, null, true, null, null, null);
    }
}
